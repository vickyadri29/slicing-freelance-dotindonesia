  ...
  return (
    <header className="flex items-center justify-between py-5">
          ...
          {navbarList.map(({ id, name, showDropdown }) => (
            ...
            >
              ...
              <span className="mt-[1px]">
                {showDropdown && <Image src={dropDownIcon} alt="dropdown" />}
              </span>
            </li>
          ))}
        </ul>
      ...
      <div className="flex items-center gap-3">
        <button className="px-5 py-2 font-semibold hover:bg-slate-50 rounded-md transition-all duration-100 ease-in outline-none active:ring active:ring-slate-300">Daftar</button>
